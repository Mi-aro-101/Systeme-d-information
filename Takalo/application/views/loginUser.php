                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><span style="color:blue;">Fidirana-Mpikambana</span></h1>
                                    </div>
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Adiresy email">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Kaody miafina">
                                        </div>
                                        <button href="index.html" class="btn btn-primary btn-user btn-block" style="font-weight: bolder; font-family:12px; background-color:#209dd8; border-color : #209dd8;" >
                                        Hiditra
                                        </button>
                                        <br>
                                        <p> Raha mbola tsy manana kaonty ianao dia afaka mamorona kaonty tsindrio ny
                                        <a href="<?php echo site_url('usercnt/insrci'); ?>" style="background-color :white; color :blue; text-decoration :none;"> Hamorona kaonty
                                        </a>
                                        </p>
