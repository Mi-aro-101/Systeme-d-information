                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><span style="color:blue;">Hamorona Kaonty Vaovao</span></h1>
                                    </div>
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Fanampin'anaranao">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Laharan tarobia">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Kaody miafina">
                                        </div>
                                        <button href="#" class="btn btn-primary btn-user btn-block" style="font-weight: bolder; font-family:12px; background-color:#209dd8; border-color : #209dd8;" >
                                        Andefa
                                        </button>
